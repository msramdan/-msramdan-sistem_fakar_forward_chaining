...
@section('content')
    <div class="container-fluid">
        {{ Breadcrumbs::render('penyakit-tambah') }}
        <div class="row">
            <div class="col-md-12">
                            ...
                            <form method="POST" action="{{ route('penyakit.store') }}">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input class="form-control @error('kd_penyakit') is-invalid @enderror" id="kd_penyakit"
                                        type="text" value="{{ $kodePenyakit }}" placeholder="Kode penyakit"
                                        name="kd_penyakit" autocomplete="off" readonly>
                                    @error('kd_penyakit')
                                ...
                                <div class="mb-3">
                                    ...
                                    <input class="form-control @error('penyakit') is-invalid @enderror" id="penyakit"
                                        type="penyakit" value="{{ old('penyakit') }}" placeholder="" name="penyakit"
                                        autocomplete="off">
                                    @error('penyakit')
                                        <span style="color: red;">{{ $message }}</span>
                                    @enderror
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea name="keterangan" class="form-control @error('keterangan') is-invalid @enderror" id="keterangan"
                                        cols="30" rows="10" autocomplete="off">{{ old('keterangan') }}</textarea>
                                    @error('keterangan')
                                        <span style="color: red;">{{ $message }}</span>
                                    @enderror
                                </div>
                                <div class="mb-3">
                                    ...
                                    <textarea name="solusi" class="form-control @error('solusi') is-invalid @enderror" id="solusi" cols="30"
                                        rows="10" autocomplete="off">{{ old('solusi') }}</textarea>
                                    @error('solusi')
                                        <span style="color: red;">{{ $message }}</span>
                                    @enderror
                                </div>
